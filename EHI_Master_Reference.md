...
FastAPI backend + React/Vite frontend hosted on Render. SQLite database (`ehi.db`) bundled with the API. First request after idle may take ~30 seconds (Render free tier spin-up).
